...
SECRET_KEY = '!p+$8kxw%i$78)m44sa0_m2lo0q!kbdc5@$u7)9-qc%n9z3)pb'
...
STATIC_ROOT = os.path.join(BASE_DIR, "files-root", "staticfiles")
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, "files-root", "media")
